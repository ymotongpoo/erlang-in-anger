...
コンスタントにかかる負荷に対しては、新しい方法が必要でしょう。
...
ある一つのプロセスに対し、キューやバッファが処理できないくらい多くのメッセージをコンスタントに送ろうとする場合、問題となるでしょう。 %TODO: 自信なし。they can't make it all, theyをqueues and buffersとみて訳しましたがあってますかね。 without overloadingは「コンスタントに送る」の表現で暗に示したつもりです
