...
\expression{system}の項は残りです。つまり、ETSテーブルや、VMの中で使われるアトムや、参照カウントされたバイナリ\footnote{詳しくは\ref{sec:binaries}節}、失われた隠しデータなどです。%TODO: hidden data I mentioned was missingがしっくりこない。
